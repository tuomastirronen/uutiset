...
for cluster in clusters:
	print ''
	for s in fs.summarize(cluster['content'], 2):
		print s
...
with open('lib/assets/classifier/data/headlines.json','r+') as f:	
	for cluster in clusters:
		for s in fs.summarize(cluster['content'], 2):
			headline = {'content': s}
			data['headlines'].append(headline)		

with open('lib/assets/classifier/data/headlines.json', 'w') as outfile:  
